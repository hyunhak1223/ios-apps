...
struct StoryBrain {
    ...
    func getQuestionText() -> String {
        return stories[questionNumber].stroyTitle
    }
    ...
    mutating  func nextStory(userAnswer: String) -> String {
        //Need to change answer to rightAnswer here.
        if userAnswer == stories[questionNumber].choice1 {
            questionNumber = stories[questionNumber].destination1
            return stories[questionNumber].stroyTitle
        } else {
            questionNumber = stories[questionNumber].destination2
            return stories[questionNumber].stroyTitle
        }
    }
    }
